            ...
            <div class="d-lg-block" id="kt_header_nav_wrapper">
                <div class="d-lg-block p-5 p-lg-0" data-kt-drawer="true"
                    ...
                    <div
                        ...
                        id="kt_landing_menu">
                        <div class="menu-item">
                            <a class="menu-link nav-link py-3 px-4 px-xxl-6 {{ request()->routeIs('home') ? 'active' : null }}" href="{{ route('home') }}">
                                Beranda </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link nav-link  py-3 px-4 px-xxl-6 {{ request()->routeIs('about-us') ? 'active' : null }}" href="{{ route('about-us') }}">
                                Tentang Kami
                            </a>
                        </div>
                        <div class="menu-item">
